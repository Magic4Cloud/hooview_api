...
//　　　　　　　　　readHttpResponse(httpResponse);
    ...
    //根据传入的getString 获取头信息里面的数据
    public static String get(String  url, Map<String, String> header,String getString) throws Exception {
        String result = "";
        CloseableHttpClient httpClient = null;
        ...
        try {
            ...
            result = httpResponse.getFirstHeader(getString).getValue();
            httpGet.abort();
        } catch (Exception e) {throw e;
        } finally {
            if (httpClient != null) {
